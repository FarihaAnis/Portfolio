/*
	...
	File Name: Database Setup
    
	The provided SQL script sets up a sales_inventory database with tables for managing customer, employee, office, order, product line, 
	and product information. It includes sample data and establishes relationships between tables using foreign key constraints. This script 
	serves as a foundation for a sales inventory management system.
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sales_inventory` /*!40100 DEFAULT CHARACTER SET latin1 */;
